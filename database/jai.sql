...
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (63,'Sea_otters_holding_hands.jpg','Sea_otters_holding_hands.jpg',NULL,'2016-11-16 16:59:41','2016-11-16 16:59:41');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (64,'Screen Shot 2016-11-16 at 5.02.10 PM.png','Screen Shot 2016-11-16 at 5.02.10 PM.png',NULL,'2016-11-16 17:02:39','2016-11-16 17:02:39');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (65,'Otter Peek a Boo.jpg','Otter Peek a Boo.jpg',NULL,'2016-11-16 17:04:59','2016-11-16 17:04:59');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (66,'Otter Peek a Boo.jpg','Otter Peek a Boo.jpg',NULL,'2016-11-16 17:07:04','2016-11-16 17:07:04');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (67,'Touch Me If You can.jpg','Touch Me If You can.jpg',NULL,'2016-11-16 17:13:10','2016-11-16 17:13:10');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (68,'watch out the crab.jpg','watch out the crab.jpg',NULL,'2016-11-16 17:16:57','2016-11-16 17:16:57');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (69,'Diving with Shark.jpg','Diving with Shark.jpg',NULL,'2016-11-16 17:25:33','2016-11-16 17:25:33');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (70,'sea trekking.jpg','sea trekking.jpg',NULL,'2016-11-16 17:36:06','2016-11-16 17:36:06');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (71,'sea trekking1.jpg','sea trekking1.jpg',NULL,'2016-11-16 17:38:44','2016-11-16 17:38:44');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (72,'seatrek.jpg','seatrek.jpg',NULL,'2016-11-16 17:40:26','2016-11-16 17:40:26');
insert  into `media`(`id`,`title`,`file_name`,`description`,`created_at`,`updated_at`) values (73,'create your own fish.jpeg','create your own fish.jpeg',NULL,'2016-11-16 17:44:03','2016-11-16 17:44:03');
...
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (2,'post','Posts','javascript:;',0,'post','fa fa-pencil',NULL,NULL,NULL,100,'backend-old');
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (3,'post.add','Add Post','jai-backend/post/add',2,'post.add',NULL,NULL,NULL,NULL,200,'backend-old');
...
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (9,'post.list','Post List','jai-backend/post',2,'post',NULL,NULL,NULL,NULL,100,'backend-old');
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (10,'category','Post Category','jai-backend/post-category/1',2,'post','',NULL,NULL,NULL,300,'backend-old');
...
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (40,'f.package','Special Packages','special-packages',38,'frontend',NULL,NULL,NULL,NULL,200,'frontend-old');
...
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (44,'f.conservation','Education and Conservation','conservation',0,'frontend','ja-icon-edu',NULL,NULL,NULL,400,'frontend-old');
insert  into `menus`(`id`,`name`,`display`,`link`,`parent_id`,`permission`,`icon_class`,`description`,`created_at`,`updated_at`,`order`,`menu_type`) values (45,'f.news','News','news',0,'frontend','ja-icon-news',NULL,NULL,NULL,500,'frontend');
...
insert  into `permissions`(`id`,`name`,`created_at`,`updated_at`) values (67,'page','2016-11-22 15:36:56','2016-11-22 15:36:56');
insert  into `permissions`(`id`,`name`,`created_at`,`updated_at`) values (68,'page.add','2016-11-22 15:37:00','2016-11-22 15:37:00');
insert  into `permissions`(`id`,`name`,`created_at`,`updated_at`) values (69,'page.edit','2016-11-22 15:37:04','2016-11-22 15:37:04');
insert  into `permissions`(`id`,`name`,`created_at`,`updated_at`) values (70,'page.delete','2016-11-22 15:37:08','2016-11-22 15:37:08');
...
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (24,'id','Quasi quidem harum accusantium harum itaque voluptas harum modi.','quasi-quidem-harum-accusantium-harum-itaque-voluptas-harum-modi-2','Alice said; but was dreadfully puzzled by the way to explain it as you might knock, and I never understood what it was: she was getting very sleepy; \'and they all looked so good, that it had made. \'He took me for his housemaid,\' she said these.');
...
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (72,'en','Shark Feeding Frenzy','shark-feeding-frenzy','Try a new experience and meet the sharks! Challenge yourself in hand-feeding this sea creature. Sharks\' food will be provided by our staff.<br /><br /><br />Lokation: Ocean Tank Walk Over');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (72,'id','Shark Feeding Frenzy','shark-feeding-frenzy-2','Rasakan pengalaman baru memberi makan hiu di Jakarta Aquarium. Anda bisa dapatkan makanan hiu dari staff kami.&nbsp;<br /><br />Lokasi: Ocean Tank Walk Over');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (73,'en','Otter Peek-a-Boo','otter-peek-a-boo','Come and meet our utterly amazing Otters who are not only fun creatures, but also highly intelligent. Take a peek of their daily activities through the glass tunnel. Who knows, you will find them holding hands while sleeping. <br /><br />Location: Otter Exhibition');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (73,'id','Otter Peek-a-Boo','otter-peek-a-boo-2','Temui dan sapa si Berang-Berang, hewan yang lucu, menggemaskan dan juga cerdas. Intip keseharian mereka melalui terowongan kaca. Siapa tahu, kamu dapat melihat mereka tidur sambil berpegangan tangan.<br /><br />Lokasi : Eksibit Berang-berang');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (77,'en','Touch Me If You Can','touch-me-if-you-can','Let them feel your love through simple touch of your hand. Introduce yourself to the Brown Banded Bamboo Shark, Blue Starfish, Turbo Snail, and other gentle animals. <br /><br />Location: Touch and Find Zone');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (77,'id','Touch Me if You Can','touch-me-if-you-can-2','Tunjukkan kasih sayangmu dengan membelai para hewan ini! Kenali hiu bambu, bintang laut biru, siput dan masih banyak lagi.<br /><br />Lokasi : Touch and Find Zone');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (78,'en','Watch Out the Crab!','watch-out-the-crab','Find out how hermit crabs spend their time inside tree truck with your magnifying glass. The warm wood chips or sand is a perfect spot for them to play.<br /><br />Location: Nurseries of the Sea');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (78,'id','Watch Out The Crab!','watch-out-the-crab-2','Temukan apa saja yang dilakukan kelomang untuk menjalani hari-harinya dengan menggunakan kaca pembesar. Serpihan kayu atau pasir yang hangat adalah tempat favorit mereka untuk bermain.<br /><br />Lokasi: Nurseries of The Sea');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (79,'en','Diving With Shark','diving-with-shark','Only here you can dive in our main tank where the Black Tip Reef Shark nestle. Our certified instructor is ready to accompany you to feel the experience. Only for licensed diver. Based on appointment. Please call us for further information. <br /><br />Location: Main Tank');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (79,'id','Diving With Shark','diving-with-shark-2','Hanya di sini anda dapat menyelam ke sarang hiu karang. Instruktur bersertifikat kami siap memandu anda. Hanya untuk penyelam yang memiliki lisensi. Berdasarkan perjanjian. Hubungi kami untuk info lebih lanjut.<br /><br />Lokasi: Main Tank');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (80,'en','Seatrekking','seatrekking','Don&rsquo;t have a diving license? You can still have the underwater adventure with this seatrekking activity. With a safety seatrek helmet, trace the handrail inside the main tank and be ready for the encounter with Black Blotch Stingray. Please call us for further info. <br /><br />Location: Main Tank');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (80,'id','Seatrekking','seatrekking-2','Tidak memiliki lisensi menyelam? Anda masih bisa merasakan serunya petualangan bawah laut dengan aktivitas seatrek. Dengan helm oksigen, telusuri panduan di akuarium utama dan bersiaplah berpapasan dengan ikan pari hitam. Hubungi kami untuk info lebih lanjut. <br /><br />Lokasi: Main Tank');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (81,'en','Create Your Own Fish','create-your-own-fish','Let your creativity play and create some cute fish as you wish. Color your favorite fish and scan your drawing. Let the fish swim freely on the screen.<br /><br />Location: Kid\'s Classroom');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (81,'id','Create Your Own Fish','create-your-own-fish-2','Kembangkan kreativitasmu dan mulai membuat ikan-ikan lucu karyamu. Warnai ikan favoritmu dan scan hasilnya. Biarkan mereka berenang bebas di layar.<br /><br />Lokasi : Kid\'s Classroom');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (82,'en','5D Theater','5d-theater','Hop on and feel the sensation as if you ride a real submarine with your close ones while exploring the deep ocean.<br /><br />Location: 5D Theater');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (82,'id','5D Theater','5d-theater-2','Masuk dan rasakan sensasi seakan berada dalam sebuah kapal selam sungguhan sembari menjelajahi lautan.<br /><br />Lokasi : 5D Theater');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (83,'en','Underwater Theaterical Show','underwater-theaterical-show','There are thousands of stories throughout the world. Our country, Indonesia, tells many wonderful stories. This is a story from a long time ago- somewhere in another time and place. Not far from here. It is the story about the devoted love of a king for his daughter. It is a story of intrigue, of adventure, deceit and compassion');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (83,'id','Underwater Theaterical Show','underwater-theaterical-show-2','Ada ribuan kisah dari seluruh dunia. Negara kita, Indonesia, juga banyak menyimpan kisah yang indah. Sebuah cerita dari zaman dahulu kala tentang kasih sayang seorang raja terhadap putrinya. Kisah petualangan yang penuh intrik dan mengharukan.<br />');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (84,'en','Pingoo Restaurant','pingoo-restaurant','This American seafood restaurant and grill is located at Neo Soho on LG floor. This fun and family restaurant is inspired by the penguin live in the southern hemisphere beach where the restaurant set in a beach deck viewing the beautiful penguin exhibit. Enjoy the experience where you can have a closer look to the penguin while enjoying our delightful menu. Kids, let\'s have fun to feed the cute Humboldt penguin.');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (84,'id','Pingoo Restaurant','pingoo-restaurant-2','Restauran dengan konsep makanan laut dan panggangan a la Amerika yang berlokasi di Neo Soho. Restauran keluarga ini terinspirasi dari habitat pinguin di daerah pantai selatan di mana restauran berada di sebuah dek di pantai yang menghadap langsung ke kawanan pinguin. Alami keseruan untuk melihat pinguin dengan lebih dekat sambil menyantap makanan anda yang lezat. Mari bersenang-senang sambil memberi makan pinguin Humboldt yang lucu!');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (85,'en','Safari Wonder','safari-wonder','Safari Wonder is part of Taman Safari Indonesia Group specialized in retail shop. Your journey wouldn&rsquo;t be complete without a memorable souvenir from Safari Wonder. Bring your memories home with adorable plush doll, cool shark t-shirt and many more. Collect them all from our store at LG floor.');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (85,'id','Safari Wonder','safari-wonder-2','Safari Wonder merupakan bagian dari Taman Safari Indonesia Group yang bergerak di bidang penjualan ritel. Perjalanan anda di Jakarta Aquarium belumlah lengkap tanpa cinderamata yang berkesan dari Safari Wonder. Bawa kenangan perjalanan Anda dengan boneka yang menggemaskan, kaus hiu yang keren dan masih banyak lagi! Koleksi semuanya dari gerai kami yang berada di lantai LG.');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (86,'en','About Us','about-us','<p>Taman Safari Indonesia Group</p>\r\n<p>presents a cutting edge family recreation,</p>\r\n<p>Jakarta Aquarium.</p>');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (86,'id','Tentang Kami','tentang-kami','<p>Taman Safari Indonesia Group</p>\r\n<p>mempersembahkan Jakarta Aquarium</p>\r\n<p>sebagai sarana rekreasi keluarga.</p>');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (87,'en','Special Package','special-package','');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (87,'id','Paket Spesial','paket-spesial','');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (88,'en','Career','career','');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (88,'id','Karir','karir','');
insert  into `post_details`(`post_id`,`lang`,`title`,`slug`,`content`) values (89,'en','Privacy Policy','privacy-policy','');
...
insert  into `post_has_categories`(`post_id`,`category_id`) values (77,17);
insert  into `post_has_categories`(`post_id`,`category_id`) values (78,17);
insert  into `post_has_categories`(`post_id`,`category_id`) values (79,17);
insert  into `post_has_categories`(`post_id`,`category_id`) values (80,17);
insert  into `post_has_categories`(`post_id`,`category_id`) values (81,17);
insert  into `post_has_categories`(`post_id`,`category_id`) values (82,18);
insert  into `post_has_categories`(`post_id`,`category_id`) values (83,18);
insert  into `post_has_categories`(`post_id`,`category_id`) values (84,19);
insert  into `post_has_categories`(`post_id`,`category_id`) values (85,19);
...
insert  into `post_has_medias`(`post_id`,`media_id`,`media_type`) values (73,66,'featured');
insert  into `post_has_medias`(`post_id`,`media_id`,`media_type`) values (77,67,'featured');
insert  into `post_has_medias`(`post_id`,`media_id`,`media_type`) values (78,68,'featured');
insert  into `post_has_medias`(`post_id`,`media_id`,`media_type`) values (79,69,'featured');
insert  into `post_has_medias`(`post_id`,`media_id`,`media_type`) values (80,72,'featured');
insert  into `post_has_medias`(`post_id`,`media_id`,`media_type`) values (81,73,'featured');
...
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (26,72,'meta_description-en','META (ENG)');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (27,72,'meta_description-id','Meta (ID)');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (36,24,'whats_on','1');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (37,24,'featured','1');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (38,86,'meta_description-en','All about JAI');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (39,86,'meta_description-id','Semua tentang JAI');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (40,86,'philosophy-en','');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (41,86,'philosophy-id','');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (42,86,'story-en','<p>Located in NEO Soho, a shopping center in West Jakarta, make Jakarta Aquarium accessible from all corners of the city.</p>\r\n<p>The combination of Indonesian biodiversity, the beauty of Indonesian heritage, and technology will become the main attraction for you and your family to escape from the midst of the capital\'s busy lifestyle.</p>');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (43,86,'story-id','<p>Terletak di Neo SOHO, salah satu pusat perbelanjaan di daerah Jakarta Barat, membuat Jakarta Aquarium sangat mudah diakses dari segala penjuru kota.</p>\r\n<p>Perpaduan keanekaragaman hayati Indonesia, keindahan budaya, dan teknologi merupakan daya tarik utama Jakarta Aquarium di tengah kesibukan ibu kota bagi Anda dan keluarga.</p>');
insert  into `post_metas`(`id`,`post_id`,`meta_key`,`meta_value`) values (44,19,'meta_description-en','You will meet the shark');
...
insert  into `post_types`(`id`,`name`,`slug`,`created_at`,`updated_at`) values (6,'Page','page','2016-11-22 00:00:00','2016-11-22 00:00:00');
...
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (19,2,'2016-10-27 18:22:34','2016-11-24 14:41:02','PUBLISH','2016-10-27 18:22:00',1);
...
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (24,2,'2016-11-03 13:19:49','2016-11-22 20:10:22','PUBLISH','2016-11-03 00:00:00',1);
...
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (72,3,'2016-11-10 18:26:45','2016-11-16 16:40:34','PUBLISH','2016-11-10 18:04:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (73,3,'2016-11-11 18:33:49','2016-11-16 17:07:10','PUBLISH','2016-11-11 18:33:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (77,3,'2016-11-16 17:13:23','2016-11-16 17:13:23','PUBLISH','2016-11-16 17:08:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (78,3,'2016-11-16 17:17:01','2016-11-16 17:17:01','PUBLISH','2016-11-16 17:13:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (79,3,'2016-11-16 17:25:47','2016-11-16 17:25:47','PUBLISH','2016-11-16 17:21:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (80,3,'2016-11-16 17:36:09','2016-11-16 17:40:32','PUBLISH','2016-11-16 17:31:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (81,3,'2016-11-16 17:44:08','2016-11-16 17:44:08','PUBLISH','2016-11-16 17:41:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (82,3,'2016-11-16 17:47:33','2016-11-16 17:47:33','PUBLISH','2016-11-16 17:44:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (83,3,'2016-11-16 17:49:46','2016-11-16 17:49:46','PUBLISH','2016-11-16 17:48:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (84,3,'2016-11-16 17:50:32','2016-11-16 17:50:51','PUBLISH','2016-11-16 17:49:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (85,3,'2016-11-16 17:52:24','2016-11-16 17:52:24','PUBLISH','2016-11-16 17:51:00',3);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (86,6,'2016-11-22 15:41:01','2016-11-24 14:17:13','PUBLISH','2016-11-22 15:40:00',1);
insert  into `posts`(`id`,`post_type_id`,`created_at`,`updated_at`,`status`,`publish_date`,`created_by`) values (87,6,'2016-11-22 15:41:21','2016-11-22 15:41:21','PUBLISH','2016-11-22 15:41:00',1);
...
insert  into `users`(`id`,`name`,`email`,`password`,`remember_token`,`created_at`,`updated_at`) values (3,'Edwina Trianinda','trianinda.edwina@gmail.com','$2y$10$iWVk/vWv/R3oa1ipa.pVgem6ypOZvDLW.F4jnbxEVODJFxbKgKHRa','c5jCFR3VIoX6rKN8nyVbudjeOTbPFH95N2Mkld6uLF3cTL0TRbVHrGvSE2s8','2016-10-12 07:41:14','2016-11-19 13:48:45');
