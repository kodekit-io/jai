                        ...
                        <div class="uk-form-row">
                            ...
                            <div class="uk-grid uk-grid-small uk-grid-match" data-uk-grid-match data-uk-grid-margin>
                                <div class="uk-width-medium-1-3">
                                    <div class="uk-panel-box cyan darken-1 white-text">
                                        <h4 class="white-text uk-margin-remove">Basic Admission</h4>
                                        <div class="jai-submission-info">General Aquarium Tour</div>
                                        <div class="jai-submission-price">Weekday IDR 200.000</div>
                                    </div>
                                    <div class="uk-panel-box jai-submission-order white uk-text-right">
                                        <input type="number" class="right" value="1">
                                    </div>
                                </div>
                                <div class="uk-width-medium-1-3">
