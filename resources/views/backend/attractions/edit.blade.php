                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title tabbable-line">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Edit Attraction</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            <form role="form" action="{!! backendUrl('attraction/' . $post->id . '/update') !!}" method="post" >
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @include('backend.partials.publish-edit-box')
