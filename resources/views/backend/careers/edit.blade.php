                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title tabbable-line">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase"> Edit Career</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            <form role="form" action="{!! backendUrl('career/' . $career->id . '/update') !!}" method="post" >
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        {{--main form--}}
                                        <div class="col-md-8">
                                            @include('backend.careers.content-edit')
                                        </div>
                                        {{--end of main form--}}
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @include('backend.careers.career-box')
